...
AFRAME.registerComponent('change-posi-on-click', {
  ...
  init: function () {
  this.el.addEventListener('click', function (evt) {
    document.getElementById("capsule-lift").setAttribute('animation__position',"property: position; dur: 3000; easing: easeInOutSine; dir: alternate; from: 9 1 10.5; to: 9 400.5 10.5; loop: false");
    document.getElementById("cameraRig").setAttribute('animation__position',"property: position; dur: 3000; easing: easeInOutSine; dir: alternate; from:9 0.526 10.5; to: 9 400.526 10.5; loop: false");
